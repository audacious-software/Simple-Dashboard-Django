...
requirejs(['material', 'cookie', 'jquery'], function (mdc, Cookies) {
  mdc.textField.MDCTextField.attachTo(document.getElementById('field_old_password'))
  mdc.textField.MDCTextField.attachTo(document.getElementById('field_new_password'))
  mdc.textField.MDCTextField.attachTo(document.getElementById('field_new_password2'))
